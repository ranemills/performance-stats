...
public class BellBoardServiceTest extends AbstractTest {
    ...
    public void testAddPerformanceWithStedman()
        throws Exception
    {
        Performance performance = getQuarterWithSpecifiedMethod("Stedman Caters");

        assertThat(performance.getMethod(), equalTo("Stedman"));
        assertThat(performance.getStage(), equalTo("Caters"));
    }
    ...
    public void testAddPerformanceWithSplicedMethodsShortMethodAndVariation()
        throws Exception
    {
        Performance performance = getQuarterWithSpecifiedMethod("Doubles (3m/3v)");

        assertThat(performance.getMethod() + " " + performance.getStage(), equalTo("(3m/3v) Doubles"));
        assertThat(performance.getMethod(), equalTo("(3m/3v)"));
        assertThat(performance.getStage(), equalTo("Doubles"));
    }
        ...
        throws Exception
    {
        ...
        for (String methodString : equivalentStrings) {
            Performance performance = getQuarterWithSpecifiedMethod(methodString);
            assertThat(performance.getStage(), equalTo("Triples"));
            assertThat(performance.getMethod(), equalTo("Spliced (4m)"));
        }
    }
        ...
        throws Exception
    {
        ...
        for (String methodString : equivalentStrings) {
            Performance performance = getQuarterWithSpecifiedMethod(methodString);
            assertThat(performance.getStage(), equalTo("Triples"));
            assertThat(performance.getMethod(), equalTo("(4m)"));
        }
    }
        ...
        throws Exception
    {
        ...
        for (String methodString : equivalentStrings) {
            Performance performance = getQuarterWithSpecifiedMethod(methodString);
            assertThat(performance.getStage(), equalTo("Major"));
            assertThat(performance.getMethod(), equalTo("Spliced Surprise (4m)"));
        }
    }
        ...
        throws Exception
    {
        ...
        for (String methodString : equivalentStrings) {
            Performance performance = getQuarterWithSpecifiedMethod(methodString);
            assertThat(performance.getStage(), equalTo("Major"));
            assertThat(performance.getMethod(), equalTo("Surprise (4m)"));
        }
    }

    private Performance getQuarterWithSpecifiedMethod(String methodString)
        throws Exception
    {
        String id = "id";
